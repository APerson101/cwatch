  ...
  Widget build(BuildContext context) {
    return Material(
      child: Container(
        ...
        children: [problemweSaw(), oursolution()],
      ))),
    );
  }
  ...
  whoarewe() {
    return Column(
      ...
      children: [
        Text("WHO ARE WE",
            style: TextStyle(
                fontSize: 27, fontWeight: FontWeight.bold, letterSpacing: 3)),
        SizedBox(height: 19),
        Text(
          "We are Students from different Universities in Africa that came together to execute this project.",
        ),
        SizedBox(height: 19),
      ],
    );
